 ...
 * @author Aluno TDS
 */
public class JFLending extends JFHome {
    ...
    private void JBSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBSearchActionPerformed
        ...
        this.JTFAuthor.setText(dialog.selected.getAuthor());
        this.JTFTitle.setText(dialog.selected.getTitle());
        this.JCBCathegory.setSelectedItem(dialog.selected.getCathegory());      
